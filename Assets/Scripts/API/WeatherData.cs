...
namespace WeatherApp.Data
{
    ...
    {
        //  JsonProperty attribute for "main"
        [JsonProperty("main")]
        public MainWeatherInfo Main { get; set; }

        //  JsonProperty attribute for "weather"
        [JsonProperty("weather")]
        public WeatherDescription[] Weather { get; set; }

        //  JsonProperty attribute for "name"
        [JsonProperty("name")]
        public string CityName { get; set; }

        //  JsonProperty attribute for "cod"
        [JsonProperty("cod")]
    ...
    {
        //  JsonProperty attribute for "temp"
        [JsonProperty("temp")]
        public float Temperature { get; set; }

        //  JsonProperty attribute for "feels_like"
        [JsonProperty("feels_like")]
        public float FeelsLike { get; set; }

        //  JsonProperty attribute for "humidity"
        [JsonProperty("humidity")]
        public int Humidity { get; set; }

        //  JsonProperty attribute for "pressure"
    ...
    public class WeatherDescription
    {
        ...
        //  JsonProperty attribute for "description"
        [JsonProperty("description")]
        public string Description { get; set; }

        //  JsonProperty attribute for "icon"
        [JsonProperty("icon")]
